...
\begin{definition}
    Sejam \(U\ab, V\ab \subseteq \R^n\). Uma aplicação \(F:U \to V\) é \emph{diffeomorfismo} de classe \(C^k\), \(^kF: U\simeq V\), se fora bijetiva, \(F \in C^k(U,\R^n)\)  e \(F^{-1} \in C^k(V,\R^n)\).    
\end{definition}
...
\hypertarget{corol81}{}
\begin{corollary}
    \textbf{8.1.} Do \(\blacksquare\) \hyperlink{thmRDC}{(\emph{Regla da Cadeia})}, se \(F\) fora diffeomorfismo, então \(\forall p \in U\), \(DF(p)\in \operatorname{GL}_n(\R)\), mas ainda, sendo \(F(p)=q\) temos,  
...
\end{example}
\begin{note}
    ¿Vale a volta do {\scriptsize \(\boxtimes\)} \hyperlink{corol81}{8.1.} em alguma vizinhaza $\V_p$? \textcolor{gray}{ Sim! }
\end{note}
