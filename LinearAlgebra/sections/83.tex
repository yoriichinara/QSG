...
\tcblower
Continuando o exemplo da seção \hyperlink{ex82}{8.2.}, sendo \(\beta = \mathscr{J}_{_T} w_{i,2} \cup w_{1,0}\) e \(\gamma = \mathscr{J}_{_T}(w) = \mathscr{C}(w)\), lembrando que \(m_{_T} = t (t-2)^3 = t^4 - 6t^3 +12t^2 -8t\) temos... 
...
\end{bmatrix}\]}
As matrizes \(P\) das congruências no \(\blacksquare\) \hyperlink{thm831}{8.3.1.} são as formadas pelos vetores das respectivas bases, ao final não são mais do que isso, mudanças de base.   
}