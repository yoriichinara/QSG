...
\begin{note}
    Sejam \(\forall j\leq k,\ T_j \in H_j := \hom(V_j, W_j)\). A função \(\psi : \Pi V_j \ni (v_j) \mapsto \otimes T_j(v_j) \in \otimes W_j \in \hom^k(\Pi V_j, \otimes W_j)\), logo \(\exists ! \widetilde{\psi} : \otimes v_j \mapsto \otimes T(v_j)\) linear. %Em geral, 
\end{note}

\hypertarget{lemma1031}{}
\begin{lemma}
   \textbf{10.3.1.} Sejam \(\forall j\leq k\), \(T_j \in H_j\). Então, 
