...
\theoremnum{9.4.4.}
\begin{theorem}
    Se \(\phi \in B_a(V)\) então \(\forall W\leq V \) complementar de \( V^\perp\), \(\exists \alpha \) base de \(V\) tal que \([\phi]_\alpha = \operatorname{diag}(0,H_m)\), onde \(m = \pt \phi/2\). \footnote{O posto de uma matriz antisimétrica sempre é par :o. }  
\end{theorem}
