...
\begin{note}
    i\((\phi)\leq \pt \phi\), \(\phi \geq 0 \ \leftrightharpoons \ \text{i}(\phi)=0\) e \(\phi < 0\ \leftrightharpoons \ \text{i}(\phi) = \dim V\). Note que a base de Sylvester fornece toda a informação, posto, indice de negatividade e assinatura.
\end{note}
