...
logo \(B_\infty(\x;\epsilon) \subset B_1(\x;\epsilon)\) e \(\tau_1 \subset \tau_\infty\). Por outro lado, 
\[\|\x\|_1 = \sum |x_i| \leq n |x_j| = n \|\x\|_\infty, \]
portanto tambem \(B_1(\x;\epsilon) \subset B_\infty(\x;n\epsilon)\) e \(\tau_\infty \subset \tau_1\). 
}
...
\end{align*}
logo \((f+g)(U) \subset B((f+g)(a), \epsilon)\).    
}
...
\vspace{0.3cm}
  {\hrule \vspace{-0.15cm}
  \centering \textbf{10} \vspace{0.1cm}
  \hrule}

B. Prove que as projeções canônicas em \(\R^2\) não são fechadas. 

\textcolor{gris}{Considere a função \(g: \R^2 \to \R \) tal que \(\x \mapsto xy\), está função é contínua, portanto, \[\{\x \in \R^2 : xy = 1\} = g^{-1}(\{1\}) =: H\ce \subset \R^2.\]  
Note que, \(\pi_x (H) = \pi_y(H) = (\R \setminus\{0\}) \ab \subset \R\).
}
