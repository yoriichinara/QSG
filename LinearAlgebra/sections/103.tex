...
\begin{lemma}
   ...
   \begin{enumerate}[label = (\alph*), left = 0.5cm]
        ...
        \item Sendo \(N_j := \cdots\otimes \ker T_j \otimes \cdots \) temos, \(\ker (\otimes T_j) = \sum N_j\). Em particular, se \(\forall j\leq k\), \(T_j \) fora injetora, então também \(\otimes T_j\) é injetora. \comentario{Não suporta resumo, olha se quiser \cite[Pág. 351]{MA719}}
   \end{enumerate}
\end{lemma}

\propositionnum{10.3.2.}
\begin{proposition}
    A função \(\varphi\) é $k$-linear e sua induzida \(\widetilde{\varphi} : \otimes H_j \to \hom(\otimes V_j, \otimes W_j)\) e injetora. Em particular, \((\varphi, [\operatorname{Im}\varphi])\) é produto tensorial.   
\end{proposition}
\comentario{Não suporta resumo, olha se quiser \cite[Pág. 352]{MA719}}
\begin{corollary}
