...
\hypertarget{corol81}{}
\begin{corollary}
    \textbf{8.1.} Do \(\blacksquare\) \hyperlink{thmRDC}{(\emph{Regla da Cadeia})}, se \(F\) é diffeomorfismo, então \(\forall p \in U\), \(DF(p)\in \hom(\R^n, \R^n)\) é invertível, mais ainda, sendo \(F(p)=q\) temos  
