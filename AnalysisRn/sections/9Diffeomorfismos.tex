...
\begin{definition}
    Sejam \(U\ab, V\ab \subseteq \R^n\). Uma aplicação \(F:U \to V\) é \emph{diffeomorfismo} de classe \(C^k\), se é bijetiva, \(F \in C^k(U,\R^n)\)  e \(F^{-1} \in C^k(V,\R^n)\).    
\end{definition}
...
\hypertarget{corol81}{}
\begin{corollary}
    \textbf{8.1.} Do \(\blacksquare\) \hyperlink{thmRDC}{(\emph{Regla da Cadeia})}, se \(F\) é diffeomorfismo, então \(\forall p \in U\), \(DF(p)\in \hom(\R^n)\) é invertível, mais ainda, sendo \(F(p)=q\) temos  
