...
\begin{lemma}
    Sejam \(A\in \operatorname{Sym}_{n}(\R)\) e \(\lambda_1, \ldots, \lambda_n\) seus autovalores. Então \(A\) é positiva (ou negativa) \(\leftrightharpoons\) \( \forall j\leq n, \ \lambda_j>0 \) (ou \(\lambda_j <0\)). \textcolor{gray}{\(\rightarrow \) Teorema Espectral}
\end{lemma}
