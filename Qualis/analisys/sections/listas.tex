...
\end{align*}
Onde \(C:= \max |f(e_{\textbf{i}})| = |f(e_{i_1}, \ldots e_{i_k})|, \ i_j \in I_j\). 
}
...
\begin{align*}
    \lim_{\|\ve\|\to 0} \frac{\sum f(\ve_{i<j})}{\|\ve\|} \leq C \lim_{\|\ve\|\to 0} \frac{\|v_i\|_i \|v_j\|_j}{\|\ve\|} \ (\ \cdots) \to 0.
\end{align*}
...
\textcolor{gris}{
    ...
    \[-1 =- \|\x\|^2 \leq  f(\x,\y) \leq \|\x\|^2 =1 .\] 
    Dados \(\vec{u}, \vec{v} \in \R^n\setminus\{\0\}\), sejam \(\x = \nicefrac{u}{\|u\|}\) e \(\y = \nicefrac{v}{\|v\|}\), 
    \begin{align*}
        |\langle u, v\rangle| =  \|u\|\|v\| |\langle \x, \y\rangle | \leq \|u\|\|v\|.
    \end{align*}
}
