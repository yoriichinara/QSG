...
\end{theorem}
\begin{proposition}
  Seja \(U\ab\subseteq \R^n\) conexo e \(f:U\to \R\) função tal que \(\forall j\leq n\) as derivadas \(f_{x_j}\equiv 0\) em \(U\), então \(f\) é constante. 
\end{proposition}
