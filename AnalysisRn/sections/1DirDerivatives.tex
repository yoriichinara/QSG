...
\ejemplo{ \centering \(\exists \alpha \in \R : f(p+hv) = f(p) + \alpha h + \sigma(h)\ \textcolor{verdeoscuro}{\Rightarrow}\  \frac{\partial f }{\partial v}(p) = \alpha\)
\tcblower
\begin{example}
...
\begin{theorem}[\emph{TVM - \(\R\)}]
  Seja \(\varphi: [0,1] \to \R\) função continua em \([0,1]\) e diff em \((0,1)\), então \(\exists \theta \in (0,1)\) tal que \(\dot{\varphi}(\theta) = \varphi(1) - \varphi(0)\). 
\end{theorem}
\begin{proposition}
