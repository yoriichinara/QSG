...
\emph{à Álgebra Linear"} - Gênesis 1:1 \hfill \href{mailto:n267452@dac.unicamp.br}{\url{n267452@dac.unicamp.br}}} %\\
%Prof. Piper Pimienta \\
%\href{mailto:pipe@dac.unicamp.br}{\url{pipe@dac.unicamp.br}}}
\end{center} %Finaliza a centralização
\- \vspace{-1cm}

{\small ** Conteúdo baseado na disciplina MM719 (Álgebra Linear) ministrada pelo professor Adriano Moura e  \cite{MA719}, de sua autoría também, no período 2025-II. **\vspace{0.3cm}}%, destinado àqueles que já possuem alguma familiaridade com o assunto, pois não contém demonstrações formais, apenas as ideias por trás delas. Sinceramente, um fã da simplicidade. \\ 
...
\input{sections/82.tex} 
\input{sections/83.tex} 
\input{sections/91.tex} 
\input{sections/92.tex} 
\input{sections/93.tex} 
\input{sections/94.tex} 
\input{sections/95.tex} 
\input{sections/96.tex} 
\input{sections/101.tex}
\input{sections/102.tex}
\input{sections/103.tex}
\input{sections/104.tex}
