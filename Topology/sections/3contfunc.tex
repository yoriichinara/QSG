...
\begin{proposition}
    \textbf{11.7.} Sejam \((X, \tau_X)\), \ \( \mathcal{D} \subset \wp(X) : X = \bigsqcup \{A : A \in \mathcal{D}\}\) e  
    \[\tau_{\mathcal{D}} = \left\{\mathcal{A}\subset \mathcal{D} : \left(\bigcup \{A : A \in \mathcal{A}\}\right)\ab \subset X\right\}.\footnote{\(\mathcal{D}\) é uma decomposição de \(X\).}\]
