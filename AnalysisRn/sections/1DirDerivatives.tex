...
\vspace{-0.3cm}
\begin{note}
  Se \(v = e_j\) então \(\frac{\partial f}{\partial x_j}(p)\) é a \textit{$j$-ésima derivada parcial} de $f$ em $p$.
\end{note}
...
\end{theorem}
\begin{proposition}
  Seja \(U\ab\subseteq \R^n\) conexo e \(f:U\to \R\) função tal que \(\forall j\leq n\) as derivadas \(\frac{\partial f}{\partial x_j}\equiv 0\) em \(U\), então \(f\) é constante. 
\end{proposition}
