...
\hypertarget{prop85}{}
\begin{proposition}
    \textbf{8.5.} Se \(^k H\subseteq \R^n\) é hipersuperficie definida por \(g(\textbf{x})=0\), \(p\in H\) e \(c\in C^k(\mathcal{V}_\epsilon;H)\) é um caminho em \(H\), então \(\ker dg(p)= \{c{'}(0): c(0) = p \}\).
\end{proposition}
