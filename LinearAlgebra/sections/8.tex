...
\begin{note}
    No caso que \(\an_{T} = \{0\}\) fazemos \(m_T :=0\) é assim que \(V = V_{m_{T}}\). Se \(S = T|_{V_p}\) então \(p \in \an_{_S}\). Também, pose-se verificar que o polinômio construido na \(\square\) \ref{prop:8.1.3} é de fato \(m_T\). 
\end{note}
...
\demo{
    É coisa de fatorar em primos, ter prensentes as propiedades \(\square\) \ref{prop:0.2} (a), \(V_{p}\subseteq V_{fp}\) e conseguir as hipótese da \(\square \) \ref{prop:8.1.7}. 
