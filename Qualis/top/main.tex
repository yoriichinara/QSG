...
\setlength{\footskip}{8mm} % Espacio entre texto y pie de página
\setlength{\parindent}{0pt} % Espacio entre texto y pie de página
\renewcommand{\footnoterule}{\vspace{5pt}\hrule width 0.3\linewidth\vspace{5pt}}
\setlength{\textheight}{795pt}
...
% \LARGE \textbf{\(^{+n}\)Notas de Materia}} \vspace{0.1in}   \\
% { \today }\\ 
% {\small
...
%{\small ** Abstrasct muito abstract . **\vspace{0.3cm}}%, destinado àqueles que já possuem alguma familiaridade com o assunto, pois não contém demonstrações formais, apenas as ideias por trás delas. Sinceramente, um fã da simplicidade. \\ 
...
%{\scriptsize$\square$} \ Lema \hspace{2.6cm} {\large$\square$} \ Proposição \hspace{1.9cm}  {\large $\blacksquare$}  \ Teorema \hspace{2.2cm} {\scriptsize $\boxtimes$}  \ Corolário }
%\begin{center}
