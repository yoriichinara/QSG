...
\begin{example}
    ...
    \[\textstyle f(p+v)= f(p) + \cancel{df(p)} + \frac{1}{2}\sum \lambda_i v_i^2 + \sigma(\|v\|^2);\]
...
\begin{lemma}
    Sejam \(A\in \operatorname{Sym}_{n}(\R)\) e \(\lambda_1, \ldots, \lambda_n\) seus autovalores. Então \(A\) é positiva (ou negativa) \(\leftrightharpoons\) \( \forall i\leq n, \ \lambda_i>0 \) (ou \(\lambda_i <0\)). \textcolor{gray}{\(\rightarrow \) Teorema Espectral}
\end{lemma}
