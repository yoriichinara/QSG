...
\begin{proposition}
    \textbf{2.10.} Dada \(f: (X,d_X)\to (Y,d_Y)\) são equivalentes:
    \vspace{-0.3cm}
    \begin{enumerate}[label = (\alph*), left = 0.6cm]
        \item \(f:X\to Y\) contínua. \hfill (b)\ \(\forall V\ab \subset Y, \ \exists U\ab \subset X : f(U) \subset V\).  
        \item[(c)] \(f^{-1}(V)\ab \subset X, \ \forall V\ab \subset Y\).  \hspace{2.25cm} (d) \ \(f^{-1}(B)\ce \subset X, \ \forall B\ce \subset Y\).
    \end{enumerate}
\end{proposition}
