...
Nesta seção \(\mathcal{I} := [0,1]\subset \R\).
\newcommand{\I}{\mathcal{I}}

\subsection*{Integração em Cadeias}

\begin{definition}
    Um \(k\)\emph{-bloco singular} em \(M\subseteq \R^n\) é uma aplicação \(\sigma \in C^\infty(\I^k, M)\).
\end{definition}

%\ejemplo{ \centering  
%    \tcblower
\begin{example}
    O $n$\emph{-bloco padrão}, \(\id_{\I^n} : \I^n \to \I^n \subset \R^n \). Uma curva suave \(c : \I \to M \) é um \(1\)-bloco singular. 
\end{example}
