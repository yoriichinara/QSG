...
\begin{proposition}
    \textbf{26.13.} Se \(\forall x,y \in X, \ \exists S_{xy} \subset X\) conexo, então \(X \) é conexo.  \comentario{Fixo \(a \in X, \ X= \underset{x \in X}{\bigcup} S_{ax}\) e \(a \in \underset{x\in X}{\bigcap}S_{ax}\), logo \(X\) é conexo, \(\square\) \hyperlink{prop2612}{26.12.} }
\end{proposition}