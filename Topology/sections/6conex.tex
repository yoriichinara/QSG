...
\begin{definition}
    Diz-se que \((X,\tau)\) é \emph{conexo por caminhos} se \(\forall a, b \in X, \ \exists f: [0,1] \to X\) função (\emph{caminho}) contínua tal que \(f(0) = a\) e \(f(1) = b \). Escrevemos \(f: a \leadsto b\).  
\end{definition}
