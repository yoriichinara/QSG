...
\hypertarget{prop84}{}
\begin{proposition}
    \textbf{8.4.} Se \(^k H\subseteq \R^n\) é hipersuperficie definida por \(g(\textbf{x})=0\), \(p\in H\) e \(c\in C^k(\mathcal{V}_\epsilon;H)\) é um caminho em \(H\), então \(\ker dg(p)= \{c{'}(0): c(0) = p \}\).
\end{proposition}
...
\hypertarget{lemma85}{}
\begin{lemma}
    \textbf{8.5.} Sejam \(V\) espaço vetorial sobre \(\R\) e \(\ell_1, \ell_2 \in V'\). Se \(\ker \ell_1 \subseteq \ker \ell_2\) então \(\exists \lambda \in \R \) tal que \(\ell_2 = \lambda \ell_1 \). 
\end{lemma}
\begin{corollary}
    \(\blacksquare\) \hyperlink{thmML}{(\emph{Multiplicadores de Lagrange})}. \textcolor{gray}{\(\rightarrow\) Segue de \(\square\) \hyperlink{prop84}{8.4.} e {\scriptsize \(\square\)} \hyperlink{lemma85}{8.5.} }
\end{corollary}
