...
\end{proposition}
\begin{note}
    Mais uma vez, é possível definir a topologia \(\tau = \{U \subset X : U \in \U_x, \ \forall x \in U\}\) a partir de uma familia verificando tais propriedades, \cite[pag. 12]{mujica2005}.
\end{note}
