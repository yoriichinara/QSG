...
\begin{definition}
    Uma função \(\phi \in \mathcal{F}( \Pi^k V_j, W)\) é $k$\emph{-linear} se é linear em cada entrada. Ou seja, \(\forall j_0\leq k\), \(\forall (v_j)_{j\neq j_0}\in \Pi V_j \) fixos, \(\forall v_{1,j_0}, v_{2,j_0} \in V_{j_0} \) e \( \forall \lambda \in \F\) temos,   
