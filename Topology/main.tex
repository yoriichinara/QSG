...
\usepackage[margin = 0.7in, bottom = 2in]{geometry}
...
\LARGE \textbf{\(^{+3}\)Notas de Topologia}} \vspace{0.1in}   \\
 { \today }\\ 
 {\small
 \vspace{0.4cm}\emph{"Eu em nenhum momento soube que era travesti" }\hfill Nestor Heli Aponte Avila\(^{1}\) \\ 
  
Ronaldo Fenômeno \hfill \href{mailto:n267452@dac.unicamp.br}{\url{n267452@dac.unicamp.br}}} %\\
%Prof. Piper Pimienta \\
%\href{mailto:pipe@dac.unicamp.br}{\url{pipe@dac.unicamp.br}}}
\end{center} %Finaliza a centralização
\- \vspace{-1cm}

{\small ** Conteúdo baseado na disciplina MM453 (Topologia) ministrada pela professora Viviana del Barco no período 2026-I, seguindo principalmente \cite{mujica2005}. **\vspace{0.3cm}}%, destinado àqueles que já possuem alguma familiaridade com o assunto, pois não contém demonstrações formais, apenas as ideias por trás delas. Sinceramente, um fã da simplicidade. \\ 
...
\- \hspace{0.6cm}{\scriptsize$\square$} \ Lema \hfill {\large$\square$} Proposição \hfill  {\large $\blacksquare$}  \ Teorema \ \  \hfill {\scriptsize $\boxtimes$}  \ Corolário \ }

{\small
\input{sections/1prel.tex}  
\input{sections/2esptop.tex}  
\input{sections/3contfunc.tex}  
\input{sections/4redyfil.tex}  
\input{sections/5regular.tex}  
\input{sections/6comp.tex}  
\input{sections/7conex.tex}  
}
...
\bibitem{mujica2005}
Mujica, Jorge (2005). \textit{Notas de Topologia Geral}, IMECC-UNICAMP.
